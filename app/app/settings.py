...
DATABASES = {
    'default': {
        ...
        'NAME': 'schoenke3_db1',                 # Your database name
        'USER': 'schoenke3',                     # Your MySQL username
...
BASE_DIR = Path(__file__).resolve().parent.parent
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_ROOT = '/home/schoenke3/development/app/media/'
FORCE_SCRIPT_NAME = '/schoenke3'
